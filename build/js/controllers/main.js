...
angular.module("DanialGithubPage.Main").controller("MainCtrl", ["$scope", "languageService", "listFactory", "$timeout", "$location", "$rootScope", "$routeParams", "loadingViewService", function ($scope, languageService, listFactory, $timeout, $location, $rootScope, $routeParams, loadingViewService) {
  var main = this;

 ...
 */
angular.module("DanialGithubPage.Main").service("languageService", ["$rootScope", "languageFactory", "loadingViewService", "$timeout", function ($rootScope, languageFactory, loadingViewService, $timeout) {
  var service = this;

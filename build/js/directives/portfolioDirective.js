...
angular.module("DanialGithubPage.Main").directive('portfolio', ["$timeout", "$location", "$window", "portfolioFactory", "$rootScope", "loadingViewService", function (timeout, location, $window, portfolioFactory, rootScope, loadingViewService) {
  return {
    restrict: 'E',
    replace: true,
    transclude: true,

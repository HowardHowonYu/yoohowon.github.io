...
angular.module("DanialGithubPage.Main").directive('selectLanguage', ["$timeout", "$location", "languageService", "listFactory", "$window", function (timeout, location, languageService, listFactory, $window) {
  return {
    restrict: 'E',
    replace: true,
    transclude: true,

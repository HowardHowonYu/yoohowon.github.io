...
angular.module("DanialGithubPage.Main").directive('mainSection', ["$timeout", "$location", "$window", function (timeout, location, $window) {
  return {
    restrict: 'E',
    replace: true,
    transclude: true,
    ...
    link: function link(scope, element, attrs, controller) {
      ...
      function getSkills() {
        var result = [];
        var skills = ["#Data Analysis", "#Deep Learning", "#Neural Network", "#JAVA", "#HTML/CSS", "#AngularJS 1.X", "#Kafka", "#Python", "#Flask", "#Web Crawling", "#Scrapy", "#Neural Network", "#Linux", "AWS", "#Spring Boot", "#MySQL", "#MongoDB", "#Gulp", "#NodeJs", "#Sketch", "#JPA"];
